...
A drawing contest website where you race against the clock — and against **Bingus**, a 2d cartoon cat 🐱, to sketch a random prompt.
...
- Other users can **vote** on submissions whenever they're online — no live judging, just async community feedback
...
4. Browse the gallery and vote on other people's submissions

## Tech

- **Frontend:** Next.js (App Router), Tailwind CSS
- **Drawing:** HTML5 Canvas (mouse + touch support)
- **Background/render effects:** Rough.js (hand-drawn hatch background on gallery page)
...
| Submission API (`/api/submissions`)   | ✅ Done |
| Gallery page (search by prompt/user)  | ✅ Done |
| Voting (like/unlike toggle)           | ✅ Done |
| Bingus's drawings per prompt          | ✅ Done |
...
_Built and playable — drawWithBingus is live._
