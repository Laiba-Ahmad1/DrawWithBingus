  ...
  return (
    <main className="w-screen h-screen overflow-hidden bg-zinc-50 flex flex-col">
      ...
      <div className="flex flex-col sm:flex-row justify-around items-center sm:items-stretch gap-1 sm:gap-20 flex-1 ">
        <div className="absolute top-2 left-2 w-[240px] h-[280px] flex flex-col items-start sm:static sm:w-[400px] sm:h-148 animate-slide-in-left">
        ...
        <div className="absolute bottom-2 right-2 w-[240px] h-[320px] flex flex-col items-end z-10 sm:static sm:w-auto sm:h-[700px] mt-0 sm:mt-40 animate-slide-in-right">
      ...
      <div className="absolute w-screen h-screen flex items-end-safe justify-center pb-10 animate-fade-in-button z-20">
        <Link
